...
import BookCategoryTypeSelector from "../common/BookCategoryTypeSelector";
import "../utils/css/validateForm.css"
import ClassNumberTypeSelector from "../classNumber/ClassNumberTypeSelector";
import { create_new_book } from "../utils/ApiFunctions";
...
const AddBook = () => {
    ...
    //two flag to control input value exist status: one to verify whether input value exist or not => handle in onChange, onBlur and onSubmit
    //and another's one to control if when the user open add book modal, the error message is hidden  => handle in onBlur and onSubmit
    ...
    const handleSubmit =async (e) => {
       ...
       try {
        //SHOW SUCCESS MESSAGE AND NAVIGATE HERE
         const new_book = await create_new_book(newBook).then(data => console.log(data));
       } catch (error) {
        console.log(error);
       }
    }
    ...
    return (
        <div>
            <form style={{width:"80%",backgroundColor:"rgba(241, 242, 246,1.0)"}} className="container shadow needs-validation">

                <div style={{borderBottom:".1rem  solid rgba(206, 214, 224,1.0)"}} className="row pt-3 pb-1 align-items-center ">
                    <div className="col-6 text-start"><span>Thêm mới sách</span></div>
                    <div className="col-6 text-end"> <button type="button"  onClick={e => handleOnCloseModal(e)} className="btn-close" aria-label="Close"></button></div>
                </div>
                ...
                <div className="row mt-3">
                    <div className="col-6">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label  htmlFor="vietnameseName" className="form-label">Tên tiếng việt</label></div>
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="bookCategory" className="form-label">Thể loại</label></div>
                            <div className="col-8  form-group"><BookCategoryTypeSelector handleBookCategoryInputChange={handleChangeInput} isValid={isValidForm["categoryId"]}/></div>
                        </div>

                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="ISBNNumber" className="form-label">Mã ISBN</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="publisher" className="form-label">Nhà xuất bản</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="language" className="form-label">Ngôn ngữ</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-price" className="form-label">Giá</label></div>
                            <div className="col-8 form-group">
                    ...
                    <div className="col-6">
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-alter-name" className="form-label">Tên khác</label></div>
                            <div className="col-8  form-group">
                                <input type="text" id="book-alter-name" onChange={(e)=>{handleChangeInput(e)}} onBlur={(e)=>handleOnBlur(e)}
                               className={`form-control ${(isValidForm["alterName"].firstChange | isValidForm["alterName"].isExistValue) 
                               | (isValidForm["vietnameseName"].firstChange |isValidForm["vietnameseName"].isExistValue) ? "":"invalid"}`}  
                               name="alterName"/> <span className="form-message">Tên tiếng việt hoặc tên khác phải có giá trị</span>
                            </div>
                        </div>

                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-class-number" className="form-label">Mã xếp giá</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-author" className="form-label">Tác giả</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-yop" className="form-label">Năm xuất bản</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-position" className="form-label">Mã vị trí</label></div>
                            <div className="col-8  form-group">
                        ...
                        <div className="row pt-2 pb-2 align-items-center">
                            <div className="col-4"><label htmlFor="book-quantity" className="form-label">Số lượng</label></div>
                            <div className="col-8  form-group">
